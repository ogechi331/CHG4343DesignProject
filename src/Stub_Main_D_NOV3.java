public class Stub_Main_D_NOV3 {
        ...
        //stub code driver class for Dylan to test integrated classes created first November 3rd, 2023 and updated to November 10th
        public static void main(String[] args) {
                ...
                PIDController.CONTROLLER_TYPE controllerType = PIDController.CONTROLLER_TYPE.PI;
                ...
                try {
                        ...
                        System.out.println("Error in driver class: " + e.getMessage());
                        System.exit(0);
                }
